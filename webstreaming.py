...
def detect(image):
    try:
        ...
        print(people)
        url="https://www.fast2sms.com/dev/bulk?authorization=hW4EFxVQIAPf9ZLxba0bFvgbXbm2mEpPJXhNu2WITNrBzmwL6KyYgDT0LFhA&sender_id=FSTSMS&message="+str(people)+" people are in danger.Need to rescue them&language=english&route=p&numbers="+str(8686519993)
